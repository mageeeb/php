...
<body>
    ...
    ?>
    <div class="cult">
        <h1 class="titre">Bienvenue sur la culture d'Athènes</h1>
        <img src="../img/culture.jpg" alt="img">
        <h2>Monuments et musées</h2>

        <ul>

            <li>
                <p> le Parthénon sur l'Acropole ;
                    ...
                    le Stade panathénaïque, refait par Hadrien et Hérode Atticus et rénové en 1896 ;</p>
            </li>
            ...
            <li>
                <p>le musée national archéologique d'Athènes qui abrite l'une des plus grandes collections d'art de la Grèce antique ;
                    ...
                    le musée juif de Grèce décrit l'histoire et la culture des Juifs de Grèce.</p>
            </li>
            <li>
                <p> le grand marché d'Athènes ;
                    ...
                    la place Syntagma et l’ancien palais royal qui abrite le Parlement.</p>
            </li>
            <li>
                <p>Natifs célèbres
                    ...
                    Vassilis Alexakis (1943-2021), écrivain franco-grec.</p>
            </li>
